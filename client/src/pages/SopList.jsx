        ...
        <main className="w-full md:w-4/5 p-4 md:p-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <button
                className="px-4 py-2 bg-purple-600 text-white font-medium rounded-xl hover:bg-purple-700 transition-all duration-300 shadow-sm text-sm whitespace-nowrap"
              >
                Search
              </button>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            {[
              ...
              <span
                key={type}
                className="px-3 py-1.5 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 rounded-full text-xs font-medium"
              >
                {type}
              </span>
            ))}
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                    {sop.structuredSteps?.length || 0} sections ·{' '}
